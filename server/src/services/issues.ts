...
const issueListSelect = {
  ...
  deliveryState: issues.deliveryState,
  blockerType: issues.blockerType,
  terminalEvidence: issues.terminalEvidence,
  nextAction: issues.nextAction,
  benjaminRequired: issues.benjaminRequired,
  autoMergeEligible: issues.autoMergeEligible,
  repoLockId: issues.repoLockId,
  antiRecurrencePatternId: issues.antiRecurrencePatternId,
  priority: issues.priority,
  assigneeAgentId: issues.assigneeAgentId,
  assigneeUserId: issues.assigneeUserId,
