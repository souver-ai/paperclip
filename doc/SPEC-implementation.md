...
- `adapter_type` text; built-ins include `process`, `http`, `claude_local`, `codex_local`, `deepseek_platform`, `gemini_local`, `opencode_local`, `pi_local`, `cursor`, and `openclaw_gateway`
