...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  ...
  deepseek_platform: { supportsInstructionsBundle: false, supportsSkills: false, supportsLocalAgentJwt: true, requiresMaterializedRuntimeSkills: false, supportsModelProfiles: false },
